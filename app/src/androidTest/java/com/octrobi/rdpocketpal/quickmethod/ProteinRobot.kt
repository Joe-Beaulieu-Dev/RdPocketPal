...
class ProteinRobot : TestRobot() {
    ...
    fun checkMinInputNanError() {
        checkEditTextError(R.id.qm_protein_grams_per_kg_min, R.string.error_enter_a_number)
    }

    fun checkMaxInputNanError() {
        checkEditTextError(R.id.qm_protein_grams_per_kg_max, R.string.error_enter_a_number)
    }
