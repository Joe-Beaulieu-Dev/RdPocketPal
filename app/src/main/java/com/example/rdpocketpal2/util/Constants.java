...
public class Constants {
    ...
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({SODIUM, CHLORINE, POTASSIUM, MAGNESIUM, CALCIUM, PHOSPHORUS})
    public @interface Element {}
    public static final int SODIUM = 0;
    public static final int CHLORINE = 1;
    public static final int POTASSIUM = 2;
    public static final int MAGNESIUM = 3;
    public static final int CALCIUM = 4;
