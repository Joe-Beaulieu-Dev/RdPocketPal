...
public class ConversionUtil {
    ...
    public static double milliequivalentsToMilligrams(@Element int element, double milliequivalents) {
        switch (element) {
            case Constants.SODIUM:
    ...
    private static double gramsToMilliequivalents(double atomicWeight, int valence, double grams) {
        return milligramsToMilliequivalents(atomicWeight, valence, grams * 1000);
    }

    private static double milliequivalentsToGrams(double atomicWeight, int valence, double milliequivalents) {
        return milliequivalentsToMilligrams(atomicWeight, valence, milliequivalents) / 1000;
    }

    private static double milligramsToMilliequivalents(double atomicWeight, int valence, double milligrams) {
        return (milligrams * valence) / atomicWeight;
    }

    private static double milliequivalentsToMilligrams(double atomicWeight, int valence, double milliequivalents) {
